...
@section('content')
    <div class="card">
        <div class="card-header d-flex align-items-center">
            <h5 class="card-title mb-0 flex-grow-1"> Rent Places  </h5>

            <div>
                <button id="addBtn" class="btn btn-primary">Add Rent Place </button>
            </div>
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg mw-650px">
            ...
            <div class="modal-content" id="modalContent">
                ...
                <div class="modal-header">
                    <!--begin::Modal title-->
                    <h2><span id="operationType"></span>  Rent Place</h2>
                    <!--end::Modal title-->
                    <!--begin::Close-->
    ...
    <script>
        var columns = [
            ...
            {data: 'desc_en', name: 'desc_en'},
             @endif
            {data: 'category_rent_id', name: 'category_rent_id'},
            {data: 'created_at', name: 'created_at'},
            {data: 'action', name: 'action', orderable: false, searchable: false},
        ];
    </script>

    @include('Admin.layouts.inc.ajax',['url'=>'rent_places'])
