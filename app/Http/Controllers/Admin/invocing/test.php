...
class Invocing extends Controller
{
    ...
    public function no_signature()
    {
        ...
        $invoice['documents'][0]['invoiceLines']=$invoiceLines ;


        //  $invoice['documents'][0]['totalDiscountAmount']=0 ;
        // $invoice['documents'][0]['totalSalesAmount']=555555555555 ;
        // $invoice['documents'][0]['netAmount']=555555555555 ;
        // $invoice['documents'][0]['taxTotals'][]=['taxType'=>'T1' , 'amount'=>0] ;
        // $invoice['documents'][0]['totalAmount']=555555555555 ;
        // $invoice['documents'][0]['extraDiscountAmount']=0 ;
        // $invoice['documents'][0]['totalItemsDiscountAmount']=0 ;



        $fullSignedFile = json_encode($invoice, JSON_UNESCAPED_UNICODE);
