...
class Invocing extends Controller
{
    ...
    public function openBat()
    {
      ...
      $x=  shell_exec($_SERVER['DOCUMENT_ROOT'] . "/envocing/SubmitInvoices2.bat");

        $path = $_SERVER['DOCUMENT_ROOT'] . "/envocing/FullSignedDocument.json";
        $path2 = $_SERVER['DOCUMENT_ROOT'] . "/envocing/Cades.txt";
        $path3 = $_SERVER['DOCUMENT_ROOT'] . "/envocing/CanonicalString.txt";
        $path4 = $_SERVER['DOCUMENT_ROOT'] . "/envocing/SourceDocumentJson.json";
